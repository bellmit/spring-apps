...
public class HongKang {
   ...
   // private String xindongguosu;
    private String erbihou;
    //yanke
 /*   private String zuoyan;
    private String youyan;*/
    private String yanke;
    ...
    private String jiazuangxian;
    private String ruxian;
    private String xiongct;
    ...
    private String baixibao_ref;
    private String hongxibao;
    private String hongxibao_ref;
    private String lixibao;
    private String lixibao_ref;
    private String xuexiaoban;
    private String xuexiaoban_ref;
    //免疫
    private String ebbingdu;
    private String leifengshiyinzi;
    private String bingganbingdukangti;
    private String bingganbingdurna;
    private String meidu;
    private String hiv;
    private String yiganbiaomiankangyuan;
    private String xuechen;
    //肝功
    private String xuebiqiu;
    private String xuebiqiu_ref;
    private String gt;
    private String gt_ref;
    private String alt;
    private String alt_ref;
    private String ast;
    private String ast_ref;
    private String tba;
    private String tba_ref;
    private String tbil;
    private String tbil_ref;
    private String tp;
    private String tp_ref;
    private String qiudanbai;
    private String qiudanbai_ref;
    private String baidanbai;
    private String baidanbai_ref;
    private String dbil;
    private String dbil_ref;
    private String alp;
    private String alp_ref;
    private String ibil;
    private String ibil_ref;
    //肾
    private String jigan;
    //血脂
    private String tc;
    private String tc_ref;
    private String tg;
    private String tg_ref;
    //血糖
    ...
    private String yibanjiancha;
    private String niaojian;
    private String xuechanggui;
    private String mianyi;
    private String gangong;
