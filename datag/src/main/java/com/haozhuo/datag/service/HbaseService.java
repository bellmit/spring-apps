...
public class HbaseService {
    ...
    public RepAbnormal getAbnormalValue(String reportId) {
        String day = esService.getchkday(reportId);
        System.out.println(day);
        StringBuffer sb = new StringBuffer(day);
        String day1 = day.substring(0, 10);
        StringBuffer sb1 = new StringBuffer(day1);
        StringBuffer rowkey = sb1.append("_" + reportId + "_");
        String endrowkey = day1+"_"+(Integer.parseInt(reportId)+1)+"_";
...
/*                if (rownmaes[2].contains("乙肝DNA") && rownmaes[3].contains("DNA")) {
    ...
    public static void main(String[] args) {
        String a ="6.51 ↑";
        String REGEX ="[^(0-9).]";
        String replace = a.replace(REGEX, "");
        String trim = Pattern.compile(REGEX).matcher(a).replaceAll("").trim();
