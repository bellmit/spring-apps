...
public class RcmdController {
    ...
    @ApiOperation(value = "输入userId,返回推荐商品的id", notes = "输入userId,返回推荐商品的id")
    ...
    @ApiOperation(value = "根据报告Id返回推荐的商品", notes = "根据报告Id返回推荐的商品")
    ...
    @ApiOperation(value = "根据videoId返回与它相似的视频列表", notes = "根据videoId返回与它相似的视频列表")
     ...
     */
    @ApiOperation(value = "根据userId获取用户的标签")
     ...
     */
    @ApiOperation(value = "根据healthReportId返回报告的标签")
     ...
     * ]
     */
    @ApiOperation(value = "根据标签返回文章的详细内容", notes = "根据标签返回文章的详细内容")
     ...
     * @return
     */
    @ApiOperation(value = "根据异常项信息(jsonStr)获取相似的资讯、视频、直播",
    ...
    @ApiOperation(value = "根据userId获取资讯、视频、直播的推荐列表")
     ...
     * 新的接口如下：
     */
    @ApiOperation(value = "根据传过来的video的标签关键词信息获取相似的资讯、视频、直播",
            notes = "根据传过来的video的标签关键词信息，获取相似的资讯、视频、直播")
    @GetMapping(value = "/mul/ALV/videoInfo")
    public Object getMulAlvByVideoInfo(
            @RequestParam(value = "pageSize", defaultValue = "20") int size,
            @RequestParam(value = "labels") String labels,
            @RequestParam(value = "keywords") String keywords,
            @RequestParam(value = "excludeVideoId") String excludeVideoId
    ) {
     ...
     * @return
     */
    @ApiOperation(value = "输入异常名和异常别名,返回匹配的文章")
    @GetMapping(value = "/article/abnorm")
    public String[] getArticleByAbnorm(
            @RequestParam(value = "pageSize", defaultValue = "20") int size,
            @RequestParam(value = "abnormialStr") String abnormialStr,
            @RequestParam(value = "abnormialAliasStr") String abnormialAliasStr) {
